...
case class Contract(id: Option[Long], idPlayer: Long, idTeam: Long, number: Option[Int] = None, initDate: Option[Date] = Some(new java.util.Date(0))
...
class ContractTable(tag:Tag) extends Table[Contract](tag, "contracts") {
  ...
  override def * =(id.?, idPlayer, idTeam, number.?, initDate.?, endDate.?, description.?
